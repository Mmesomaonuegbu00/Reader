...
const page = () => {
    return (
        <div className='flex flex-col gap-16'>
            ...
            <div className='flex justify-center lg:flex-row flex-col max-w-6xl mx-auto'>
                <Image src='/rich.webp' alt='image' width={500} height={500} priority className='w-[300px] lg:w-[350px] mx-auto border border-green-500 p-1.5 rounded-xl' />
            ...
            <div className='flex justify-center flex-col max-w-6xl mx-auto text-center pt-16'>
                ...
                <div className='grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-6 mx-auto pt-20 text-center text-gray-700 '>
                    <div className='max-w-[300px] mx-auto'>
                        <h1 className='font-semibold text-3xl pb-8'>BEng Electronic Engineering</h1>
                        <p>September 2000 - May 2004 University Of California</p>
                    </div>

                    <div className='max-w-[300px] mx-auto'>
                        <h1 className='font-semibold text-3xl pb-8'>MSc in Research Methodology</h1>
                        <p>September 2000 - May 2004 University Of California</p>
                    </div>
            ...
            <div className='bg-[#f2f3f2] pt-[4vh] pb-16'>
                <div className='flex justify-between lg:flex-row flex-col max-w-6xl mx-auto gap-20 pt-20'>
                    ...
                    <Image src='/mission.png' alt='image' width={500} height={500} className='w-[300px] lg:w-[350px] mx-auto ' />
