      ...
      <div className='w-[90%] lg:w-[80%] mx-auto my-auto'>
        <div className='flex items-center h-full justify-between py-8'>
          ...
          <ul className='hidden xl:flex items-center space-x-10'>
            ...
            <li>
              <Link href="/contact" className="text-base font-semibold text-gray-800">
                Contact
              </Link>
            </li>
          ...
          <div className='flex gap-2 items-center'>
            ...
            <div className="relative w-12 sm:w-full sm:max-w-sm">
              <input
                type="text"
                className="w-full border border-gray-300 text-sm outline-none p-2 pr-10 rounded-lg bg-[#f2f3f2] placeholder:lg:block placeholder:hidden sm:p-2 sm:pr-10 sm:rounded-lg mx-auto"
